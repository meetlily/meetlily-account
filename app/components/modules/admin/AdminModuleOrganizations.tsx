...
interface AdminModuleOrganizationsProps {
	installed?: Module[];
	fields?: Formfield[];
	modules?: LocalModule[];
	users?: any[];
...
const AdminModuleOrganizations: React.FC<AdminModuleOrganizationsProps> = ({
	installed,
	fields,
	modules,
	users,
	...
	const deleteModalActionClick = useCallback(
		(item: any) => {
			axios
				.delete(`/api/organization/${item.id}`)
				.then(() => {
...
export default AdminModuleOrganizations;
