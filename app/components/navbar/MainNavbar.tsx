...
const MainNavbar: React.FC<MainNavbarProps> = ({ currentUser }) => {
							...
							<>
								...
								>
									...
									<div className="bg-white rounded-b-md">
										<Dropdown.Item onClick={accountModal.onOpen} icon={FaUser} className="py-3">
											Account
										</Dropdown.Item>
										<Dropdown.Item icon={AppIcons['documentation']} className="py-3">
											Documentation
										</Dropdown.Item>
