    ...
    <>
        ...
        {!ContentText && (
            <div className="flex flex-wrap gap-2">
                {status ? (
                    <Avatar stacked={stacked} statusPosition={statPosition} status={status} alt={alt} img={img} bordered={bordered} className={classNames} rounded={rounded} />
                ) : (
                    <Avatar stacked={stacked} alt={alt} img={img} bordered={bordered} className={classNames} rounded={rounded} />
                )}
            </div>
        )}
